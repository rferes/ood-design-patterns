...
class Vehicle:
    ...
    def __init__(self, license_plate: str, type: VehicleType) -> None:
    ...
    def __eq__(self, other) -> bool:
        return (
            ...
            and self.license_plate == other.license_plate
        )
    ...
    def __repr__(self) -> str:
        return f"Vehicle (License Plate: {self.license_plate}, Type: {self.vehicle_type.value})."
...
def demo():
    ...
    # Test: Park vehicle
    vehicle1 = Vehicle("ABC-123", VehicleType.CAR)
    print(vehicle1)
